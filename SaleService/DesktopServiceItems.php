    ...
    <div class="container no-bottom">
        <div class="one-half-responsive">
            ...
            <div class="big-notification red-notification">
                <h4 class="uppercase">电脑系统</h4>
                <a href="#" class="close-big-notification">购买</a>
                <p>专业安装系统，升级系统，提供正版系统以及系统维护，及其各类软件安装。</p>

                <div class="container itemsdetails">
                <a href="#" class="submenu-nav-deploy">详细列表</a>
                <div class="submenu-nav-items">
                    <a >项目一<p href="#" class="checkbox radio-two" >&nbsp;</p></a>
                    <a >项目二<p href="#" class="checkbox radio-two" >&nbsp;</p></a>
                    <a >项目三<p href="#" class="checkbox radio-two" >&nbsp;</p></a>          
                 </div>
                </div>
            </div>	
            ...
            <div class="big-notification green-notification">
                <h4 class="uppercase">电脑硬件</h4>
                <a href="#" class="close-big-notification">购买</a>
                <p>电脑各种硬件维修，更换，维护，提供正品保证的硬件，以及售后服务。</p>
                <div class="container itemsdetails">
                <a href="#" class="submenu-nav-deploy">详细列表</a>
                <div class="submenu-nav-items">
                    <a >项目一<p href="#" class="checkbox radio-two" >&nbsp;</p></a>
        ...
        <div class="one-half-responsive last-column">
            <div class="big-notification yellow-notification">
                <h4 class="uppercase">电脑清理</h4>
                <a href="#" class="close-big-notification">购买</a>
                <p>深层清理电脑灰尘，维护电脑硬件，让电脑焕然一新的同时增加寿命，使其工作环境达到最佳！</p>
                <div class="container itemsdetails">
                <a href="#" class="submenu-nav-deploy">详细列表</a>
                <div class="submenu-nav-items">
                    <a >项目一<p href="#" class="checkbox radio-two" >&nbsp;</p></a>
